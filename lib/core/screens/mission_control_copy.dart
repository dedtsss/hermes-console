...
final class MissionControlCopy {
  ...
  String get allAgents =>
      _strings?.missionAllAgents ??
      (_english ? 'All agents' : 'Todos los agentes');
  ...
  String get work => _strings?.missionWork ?? (_english ? 'Work' : 'Trabajo');
  ...
  String get newAgent =>
      _strings?.missionNewAgent ?? (_english ? 'New agent' : 'Nuevo agente');
  ...
  String get searchAgents =>
      _strings?.missionSearchBots ?? (_english ? 'Search bots' : 'Buscar bots');
  ...
  String get allBots =>
      _strings?.missionAllBots ?? (_english ? 'All bots' : 'Todos los bots');
